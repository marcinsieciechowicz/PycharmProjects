...
# masz stringa a = 'bardzo wielka anakonda'
# przy uzyciu slicow a[x:y:z] wypisz:
# samo slowo 'anakonda'
# co trzecia litere stringa
# co druga litere stringa zaczynajac od indeksu=2, konczac na indeksie=12
...
# przy uzyciu TDD - Test Driven Development
# napisz testy do funkcji, ktora pobiera stringa i:
# jesli dlugosc stringa jest z przedzialu <0,3> - drukuje "krotki"
# jesli dlugosc stringa jest z przedzialu <4,10> - drukuje "sredni"
# jesli dlugosc stringa jest z przedzialu <11, do nieskonczonosci> - drukuje "dlugi"
...
# sprawdz czy podana liczba (parametr z klawiatury lub zmienna)
# znajduje sie na liscie czy nie
# a) uzyj do tego petli for
# b) uzyj wyszukiwania binary search (indeks lewy, prawy, srodkowy)

# ex35_reverse_string.py - na dole jest rozwiazanie ale sprobujcie samemu
